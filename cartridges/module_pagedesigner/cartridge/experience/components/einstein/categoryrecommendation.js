...
module.exports.render = function (context) {
    ...
    if (model.limit > 1) {
        ...
        return new Template('experience/components/einstein/category-to-productcarousel').render(model).text;
    }
    return new Template('experience/components/einstein/category-to-producttile').render(model).text;
};
